...
4. Record the contribution basis and structured Contribution Signal. Discovery candidates may be explored or have a local Issue/Discussion draft prepared while no public signal exists. Before implementation, publish the external Issue/Discussion record or record valid reproducible evidence; do not wait for a maintainer reply. Reproducible evidence also requires explicit policy allowance.
